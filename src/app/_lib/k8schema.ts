...
/**
 * DeploymentSpec to control the desired behavior of rolling update.
 */
...
export class V1APIService {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec contains information for locating and communicating with a server
     */
...
export class V1ConfigMapNodeConfigSource {
    ...
    'namespace': string;
    /**
     * ResourceVersion is the metadata.ResourceVersion of the referenced ConfigMap. This field is forbidden in Node.DeploymentSpec, and required in Node.Status.
     */
    'resourceVersion': string;
    /**
     * UID is the metadata.UID of the referenced ConfigMap. This field is forbidden in Node.DeploymentSpec, and required in Node.Status.
     */
    'uid': string;
}
...
export class V1LimitRange {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
...
export class V1LocalSubjectAccessReview {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.
     */
...
export class V1Namespace {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the behavior of the Namespace. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
...
export class V1Node {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
    'spec': V1NodeSpec;
    /**
...
/**
 * NodeConfigStatus describes the status of the config assigned by Node.DeploymentSpec.ConfigSource.
 */
export class V1NodeConfigStatus {
    ...
    /**
     * Assigned reports the checkpointed config the node will try to use. When Node.DeploymentSpec.ConfigSource is updated, the node checkpoints the associated config payload to local disk, along with a record indicating intended config. The node refers to this record to choose its config checkpoint, and reports this record in Assigned. Assigned only updates in the status after the record has been checkpointed to disk. When the Kubelet is restarted, it tries to make the Assigned config the Active config by loading and validating the checkpointed payload identified by Assigned.
     */
    'assigned': V1NodeConfigSource;
    /**
     * Error describes any problems reconciling the DeploymentSpec.ConfigSource to the Active config. Errors may occur, for example, attempting to checkpoint DeploymentSpec.ConfigSource to the local Assigned record, attempting to checkpoint the payload associated with DeploymentSpec.ConfigSource, attempting to load or validate the Assigned config, etc. Errors may occur at different points while syncing config. Earlier errors (e.g. download or checkpointing errors) will not result in a rollback to LastKnownGood, and may resolve across Kubelet retries. Later errors (e.g. loading or validating a checkpointed config) will result in a rollback to LastKnownGood. In the latter case, it is usually possible to resolve the error by fixing the config assigned in DeploymentSpec.ConfigSource. You can find additional information for debugging by searching the error message in the Kubelet log. Error is a human-readable description of the error state; machines can check whether or not Error is empty, but should not rely on the stability of the Error text across Kubelet versions.
     */
    'error': string;
    /**
     * LastKnownGood reports the checkpointed config the node will fall back to when it encounters an error attempting to use the Assigned config. The Assigned config becomes the LastKnownGood config when the node determines that the Assigned config is stable and correct. This is currently implemented as a 10-minute soak period starting when the local record of Assigned config is updated. If the Assigned config is Active at the end of this period, it becomes the LastKnownGood. Note that if DeploymentSpec.ConfigSource is reset to nil (use local defaults), the LastKnownGood is also immediately reset to nil, because the local default config is always assumed good. You should not make assumptions about the node's method of determining config stability and correctness, as this may change or become configurable in the future.
     */
...
export class V1PersistentVolume {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines a specification of a persistent volume owned by the cluster. Provisioned by an administrator. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
     */
...
export class V1PersistentVolumeClaim {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
     */
...
export class V1ReplicaSet {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
...
export class V1ReplicationController {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the specification of the desired behavior of the replication controller. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
...
export class V1ResourceQuota {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the desired quota. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
...
/**
 * DeploymentSpec to control the desired behavior of daemon set rolling update.
 */
...
export class V1SelfSubjectAccessReview {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec holds information about the request being evaluated.  user and groups must be empty
     */
...
export class V1SelfSubjectRulesReview {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec holds information about the request being evaluated.
     */
...
export class V1Service {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the behavior of a service. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
    'spec': V1ServiceSpec;
    /**
...
export class V1StatefulSet {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec defines the desired identities of pods in this set.
     */
...
export class V1beta1CustomResourceDefinition {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec describes how the user wants the resources to appear
     */
...
export class V1beta1CustomResourceSubresourceScale {
    ...
    /**
     * SpecReplicasPath defines the JSON path inside of a CustomResource that corresponds to Scale.DeploymentSpec.Replicas. Only JSON paths without the array notation are allowed. Must be a JSON Path under .spec. If there is no value under the given path in the CustomResource, the /scale subresource will return an error on GET.
     */
...
export class V1beta1Ingress {
    ...
    'metadata': V1ObjectMeta;
    /**
     * DeploymentSpec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     */
...
export class V1beta1IngressRule {
    /**
     * Host is the fully qualified domain name of a network host, as defined by RFC 3986. Note the following deviations from the \"host\" part of the URI as defined in the RFC: 1. IPs are not allowed. Currently an IngressRuleValue can only apply to the    IP in the DeploymentSpec of the parent Ingress. 2. The `:` delimiter is not respected because ports are not allowed.    Currently the port of an Ingress is implicitly :80 for http and    :443 for https. Both these may change in the future. Incoming requests are matched against the host before the IngressRuleValue. If the host is unspecified, the Ingress routes all traffic based on the specified IngressRuleValue.
     */
    'host': string;
